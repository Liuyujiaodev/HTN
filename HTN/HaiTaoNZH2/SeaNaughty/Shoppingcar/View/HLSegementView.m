...
- (void)calculatorWidths{
    ...
    for (NSString *title in self.titles) {
        ...
        NSMutableDictionary *dic = [NSMutableDictionary dictionaryWithObject:[UIFont systemFontOfSize:11] forKey:NSFontAttributeName];
...
{
    CGRect titleBoundsR = [rightLabel.text boundingRectWithSize:CGSizeMake(MAXFLOAT, 0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:@(11)} context:nil];
    
    CGRect titleBoundsL = [leftLabel.text boundingRectWithSize:CGSizeMake(MAXFLOAT, 0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:@(11)} context:nil];
...
- (UIScrollView *)titleScrollView{
    if (!_titleScrollView) {
        ...
        _titleScrollView.backgroundColor = LineColor;
