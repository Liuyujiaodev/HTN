...
@interface NewProductDetailVC () <WKNavigationDelegate,UITableViewDelegate,UITableViewDataSource,LLSegmentBarDelegate,SkuCountDelegate,SkuFilterResultDelegate>
...
- (void)postProductSku:(NSDictionary *)sku selectArray:(NSArray *)selectArray
{
    ...
    else
    {
        ...
        //
        _model = nil;
        //        [self getProductWithSku:_productId];
